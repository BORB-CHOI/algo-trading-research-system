...
| [0021](0021-period-bars-from-daily.md) | 주·월봉은 일봉으로 만들고 매일 전수 대조 | 수락 |
| [0022](0022-minute-bars-from-one-minute.md) | 굵은 분봉은 1분봉으로 만들고 전수 대조 | 수락 (2026-08-29) |
| [0023](0023-min1-two-brokers.md) | 1분봉은 시장마다 창구 하나씩(전부 키움) · 한도 끝까지 | 수락 (2026-08-30) |
| [0024](0024-llm-research-partner.md) | LLM 은 리서치 파트너 + 5단계 구조로 개편 | 수락 (2026-09-11) |
