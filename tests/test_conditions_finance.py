...
SUMMARY = pd.DataFrame(
    [
        {
            "code": "AAAAAA", "year": 2024, "disclosed": pd.Timestamp("2025-03-15"), "fs_div": "CFS",
            "매출액": 1000.0, "영업이익": 200.0, "당기순이익": 150.0,
            "자산총계": 3000.0, "부채총계": 1000.0, "자본총계": 2000.0,
            "매출액_전기": 800.0, "영업이익_전기": 100.0,
        },
        {
            "code": "AAAAAA", "year": 2025, "disclosed": pd.Timestamp("2026-03-15"), "fs_div": "CFS",
            "매출액": 2000.0, "영업이익": 100.0, "당기순이익": 80.0,
            "자산총계": 3500.0, "부채총계": 1200.0, "자본총계": 2300.0,
            "매출액_전기": 1000.0, "영업이익_전기": 200.0,
        },
        {
            "code": "BBBBBB", "year": 2024, "disclosed": pd.Timestamp("2025-03-20"), "fs_div": "OFS",
            "매출액": 500.0, "영업이익": -50.0, "당기순이익": -80.0,
            "자산총계": 900.0, "부채총계": 1000.0, "자본총계": -100.0,
            "매출액_전기": 400.0, "영업이익_전기": -20.0,
        },
    ]
)
...
def test_허용되지_않은_선택지는_거부한다():
    with pytest.raises(ValueError, match="흑자"):
        C.parse_conditions([{"key": "profit_sign", "params": {"대상": "영업이익", "구분": "반흑자"}}])
