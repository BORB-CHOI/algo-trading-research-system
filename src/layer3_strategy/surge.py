...
**갭 상승 함정:** 급등 첫날이 갭으로 뜨면 그날 Open 은 이미 올라간 가격이다. (2) 규칙은
갭 전날의 낮은 시가를 고르므로 앵커 시작가가 갭 아래로 내려간다. 의도한 보수적 선택이다 —
파동폭이 커져 되돌림 레벨이 낮게 잡히고, 결과는 "더 싸게 걸어 안 사고 지나칠" 쪽으로
틀린다. 비싸게 사는 방향으로 틀리지 않는다.
