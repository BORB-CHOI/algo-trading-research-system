...
from src.layer2_backtest.backtest import (
    MIN_RELIABLE_TRADES,
    Trade,
    resolve_period,
    run_symbol,
...
from src.layer2_backtest.slippage import SqrtImpactSlippage
...
def _resolve_strategy(key: str) -> StrategyFn:
    ...
    """
    from src.layer2_backtest.case_overlay import STRATEGIES  # 지연 임포트 — 개편 대비 격리
...
def _load_selection_panel(
    ...
    (2025-03-04 개장 이후 날짜만 — src/layer1_market_data/unified.py).
    """
